    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                ...
                <!-- /.box-header -->
                <!-- form start -->
                <form role="form" action="{{ route('admin.country.store') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="short_description" cols="30" rows="5" class="form-control" required></textarea>
                        </div>
